...
public class DataBinderMapperImpl extends DataBinderMapper {
  private static final int LAYOUT_ACTIVITYRESTAURANTS = 1;

  private static final int LAYOUT_RESTAURANTITEM = 2;
  ...
  public ViewDataBinding getDataBinder(DataBindingComponent component, View view, int layoutId) {
    ...
    if(localizedLayoutId > 0) {
      ...
      switch(localizedLayoutId) {
        case  LAYOUT_ACTIVITYRESTAURANTS: {
          if ("layout/activity_restaurants_0".equals(tag)) {
            return new ActivityRestaurantsBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for activity_restaurants is invalid. Received: " + tag);
        }
        case  LAYOUT_RESTAURANTITEM: {
          if ("layout/restaurant_item_0".equals(tag)) {
            return new RestaurantItemBindingImpl(component, view);
          }
          throw new IllegalArgumentException("The tag for restaurant_item is invalid. Received: " + tag);
        }
      }
    }
    return null;
